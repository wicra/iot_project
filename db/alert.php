...
<script>
/////////////////////////////////////////////////////////
//            CONDITION DE FERMETURE ALERT             //
/////////////////////////////////////////////////////////

var closeButtons = document.querySelectorAll('.close_button');
// Boucler à travers chaque bouton de fermeture et ajouter un gestionnaire d'événements de clic
closeButtons.forEach(function(button) {
    button.addEventListener('click', function() {
        // Trouver l'élément parent du message et le cacher
        var messageId = this.closest('.error_message').getAttribute('data-id');
